...
public class BestFirst {
	...
	private static ArrayList<ArrayList<Integer>> expanded_states = null;
	...
	public BestFirst(ArrayList<Integer> initial_state, ArrayList<Integer> final_state, boolean verbose, boolean repeats) {
	...
	public static ArrayList<Node> run(){
		/*
			...
			2.    Dequeue the best node and examine it
